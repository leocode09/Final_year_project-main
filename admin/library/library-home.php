 ...
 <header class="reg-header">
    <nav class="secretary__nav">
        <ul>
            ...
            <li><a href="library-home.php" class="here">Home</a></li>
            <li><a href="library-add-problem.php">add problem</a></li>
        ...
        <div class="container">
            <div class="reg-card">
                ...
                <div class="desc">
                    <h1>PROBLEMS</h1>
                    <?php 
                    $sql=" SELECT count(rollnumber) as sum FROM student_lib_problem";
