...
if (isset($_POST["marks_edit_problem"])) {
    $newproblem = $_POST['problem'];
    $sql = "UPDATE `student_marks_problem` set problem='$newproblem' where rollnumber='$id'";
...
if (isset($_SESSION['role'])) {
    ...
    <body>
            ...
            <div class="student-form">
                ...
                <form method="post">
                    ...
                    <div class="student-problem">
                        ...
                        <div class="form-group">
                            <input id="btn" type="submit" name="marks_edit_problem" value="Done">
                        </div>
        ...
        <script src="https://cdnjs.cloudflare.com/ajax/markss/jquery/3.6.0/jquery.min.js"></script>
        <script src="https://cdnjs.cloudflare.com/ajax/markss/select2/4.1.0-beta.1/js/select2.min.js"></script>
