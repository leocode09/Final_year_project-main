...
<body>
    ...
    <section  class="student-main">
        <a href="fin_manage_problems.php"><i class="fa-solid fa-eye"></i>Manage Student Problem</a>
        <div class="student-form">
            <h1>ADD STUDENT PROBLEM </h1>
            <form action="backend/fin_add_problem.php" method="post">
            ...
            <?php include('../function.php')?>
                <div class="student-problem">
                    ...
                    <div class="form-group">
                        <input id="btn" type="submit" name="finance-add-problem" value="Add">
                    </div>
